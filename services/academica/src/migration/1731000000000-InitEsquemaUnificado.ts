...
export class InitEsquemaUnificado1731000000000 implements MigrationInterface {
  name = "InitEsquemaUnificado1731000000000";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "programas_metodologia_estrategias";`
    );
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "programa_curso_requisitos";`
    );
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "cronograma_grupos_docentes";`
    );
