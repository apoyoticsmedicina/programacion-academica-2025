...
exports.UsuarioCursoController = void 0;
const usuarioCursoService_1 = require("../services/usuarioCursoService");
const service = new usuarioCursoService_1.UsuarioCursoService();
class UsuarioCursoController {
    ...
    async listMine(req, res) {
        const userId = req.user?.id; // o req.user?.id si ya tipaste Express.Request
        if (!userId) {
...
exports.UsuarioCursoController = UsuarioCursoController;
//# sourceMappingURL=usuarioCursoController.js.map